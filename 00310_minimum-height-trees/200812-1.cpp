...
int main()
{
	...
	}
	{
		...
		print(s.findMinHeightTrees(2, a)); // answer: [0, 1]
	}
	{
		vector<vector<int>> a = {{0,1},{0,2},{0,3},{3,4},{4,5}};
		print(s.findMinHeightTrees(6, a)); // answer: [3]
	}
	{
		vector<vector<int>> a = {{0,1},{1,2},{1,3},{2,4},{3,5},{4,6}};
		print(s.findMinHeightTrees(7, a)); // answer: [1, 2]
	}
	{
		vector<vector<int>> a = {};
		print(s.findMinHeightTrees(1, a)); // answer: [0]
	}
	return 0;
	{
